...
public class CourseController {
    ...
    public void createDummyData() {
        courseService.createCourse(new CourseCreateDTO("Biologie", 30));
        courseService.createCourse(new CourseCreateDTO("Geschiedenis", 30));
        courseService.createCourse(new CourseCreateDTO("Wiskunde", 30));
        courseService.createCourse(new CourseCreateDTO("Scheikunde", 30));
    }
